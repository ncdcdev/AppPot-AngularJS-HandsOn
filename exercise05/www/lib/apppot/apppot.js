...
/***/ function(module, exports, __webpack_require__) {
	...
	var database_1 = __webpack_require__(18);
	var model_1 = __webpack_require__(20);
	var user_1 = __webpack_require__(124);
	...
	var AppPot = (function () {
	    ...
	    AppPot.prototype.getBuildDate = function () {
	        return (1473304193) || "unknown";
	    };
	    AppPot.prototype.getVersion = function () {
	        return '2.3.1' || "unknown";
	    };
	        ...
	        classList[_className] = (function () {
	            ...
	            ModelClass.insert = function (data) {
	                var func = function (resolve, reject) {
	                    ...
	                    __data = _data.map(function (record) {
	                    ...
	                    appPot.getAjax().post("data/batch/addData") //${_className}`)
	                        ...
	                        obj['results'].forEach(function (val, idx) {
	                            var createdColumns = objectAssign(__data[idx], val);
	                            ret.push(createModelInstance(_className, createdColumns));
	                        });
	                        resolve(ret);
	                    }));
	                };
	            ...
	            ModelClass.parseColumns = function (columns) {
	                ...
	                classList[_className].dateColumns.forEach(function (val) {
...
;
//# sourceMappingURL=apppot.js.map